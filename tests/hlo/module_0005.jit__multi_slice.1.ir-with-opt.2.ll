...
define void @slice_3(i8* noalias nocapture readonly align 16 dereferenceable(65536) %alloc0, i8* noalias nocapture writeonly align 128 dereferenceable(16384) %alloc2) local_unnamed_addr #1 {
entry:
  ...
  %13 = getelementptr inbounds float, float addrspace(1)* %12, i64 4096
  %14 = load float, float addrspace(1)* %13, align 16, !invariant.load !11
  %15 = bitcast i8 addrspace(1)* %alloc23 to float addrspace(1)*
  ...
  %20 = getelementptr inbounds float, float addrspace(1)* %19, i64 4096
  ...
  %24 = getelementptr inbounds float, float addrspace(1)* %23, i64 4096
  ...
  %28 = getelementptr inbounds float, float addrspace(1)* %27, i64 4096
