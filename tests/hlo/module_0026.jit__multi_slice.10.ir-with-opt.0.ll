...
define void @slice_4(i8* noalias nocapture readonly align 16 dereferenceable(262144) %alloc0, i8* noalias nocapture writeonly align 128 dereferenceable(65536) %alloc3) local_unnamed_addr #1 {
entry:
  ...
  %9 = getelementptr inbounds float, float addrspace(1)* %8, i64 32
  ...
  %16 = bitcast i8 addrspace(1)* %alloc33 to float addrspace(1)*
