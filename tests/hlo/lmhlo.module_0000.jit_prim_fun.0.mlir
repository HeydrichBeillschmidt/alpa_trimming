module attributes {hlo.unique_id = 0 : i32, mhlo.unique_id = 0 : i64} {
  func @main.3(%arg0: memref<4xi8> {lmhlo.params = 0 : index}, %arg1: memref<65536xi8> {lmhlo.output_index = dense<> : tensor<0xi64>}) attributes {result_xla_shape = "f32[128,128]{1,0}"} {
