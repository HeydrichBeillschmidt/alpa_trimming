...
define void @slice_3(i8* noalias nocapture readonly align 16 dereferenceable(4096) %alloc0, i8* noalias nocapture writeonly align 128 dereferenceable(1024) %alloc2) local_unnamed_addr #1 {
entry:
  ...
  %17 = bitcast i8 addrspace(1)* %alloc23 to float addrspace(1)*
