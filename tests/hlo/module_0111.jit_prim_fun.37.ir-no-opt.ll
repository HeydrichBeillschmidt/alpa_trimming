...
define void @broadcast_2(i8* noalias align 16 dereferenceable(4) %alloc0, i8* noalias align 128 dereferenceable(82944) %alloc1) {
entry:
  %0 = getelementptr inbounds i8, i8* %alloc0, i64 0
  %1 = bitcast i8* %0 to float*
  %2 = getelementptr inbounds i8, i8* %alloc1, i64 0
  %3 = bitcast i8* %2 to [144 x [144 x float]]*
  ...
  %linear_index_in_range = icmp ult i32 %linear_index, 5376
  call void @llvm.assume(i1 %linear_index_in_range)
  %linear_index_base = mul nuw nsw i32 %linear_index, 4
  %7 = udiv i32 %linear_index_base, 1
  %8 = urem i32 %7, 144
  %9 = udiv i32 %linear_index_base, 144
  %linear_index1 = add nuw nsw i32 %linear_index_base, 1
  %10 = udiv i32 %linear_index1, 1
  %11 = urem i32 %10, 144
  %12 = udiv i32 %linear_index1, 144
  %linear_index2 = add nuw nsw i32 %linear_index_base, 2
  %13 = udiv i32 %linear_index2, 1
  %14 = urem i32 %13, 144
  %15 = udiv i32 %linear_index2, 144
  %linear_index3 = add nuw nsw i32 %linear_index_base, 3
  %16 = udiv i32 %linear_index3, 1
  %17 = urem i32 %16, 144
  %18 = udiv i32 %linear_index3, 144
  %19 = icmp ult i32 %linear_index_base, 20736
...
broadcast_2.in_bounds-true:                       ; preds = %entry
  ...
  %21 = bitcast [144 x [144 x float]]* %3 to float*
  ...
  %24 = bitcast [144 x [144 x float]]* %3 to float*
  ...
  %27 = bitcast [144 x [144 x float]]* %3 to float*
  ...
  %30 = bitcast [144 x [144 x float]]* %3 to float*
