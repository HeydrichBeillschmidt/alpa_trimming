...
define void @fusion(i8* noalias align 16 dereferenceable(4) %alloc0, i8* noalias align 16 dereferenceable(4) %alloc1, i8* noalias align 128 dereferenceable(4) %alloc2) {
entry:
  ...
  br i1 %9, label %fusion.in_bounds-true, label %fusion.in_bounds-after
