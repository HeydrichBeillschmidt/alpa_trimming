...
entry:
  ...
  %3 = bitcast i8* %2 to [64 x [256 x [4 x float]]]*
...
broadcast_2.in_bounds-true:                       ; preds = %entry
  ...
  %29 = bitcast [64 x [256 x [4 x float]]]* %3 to float*
  ...
  %32 = bitcast [64 x [256 x [4 x float]]]* %3 to float*
  ...
  %35 = bitcast [64 x [256 x [4 x float]]]* %3 to float*
  ...
  %38 = bitcast [64 x [256 x [4 x float]]]* %3 to float*
