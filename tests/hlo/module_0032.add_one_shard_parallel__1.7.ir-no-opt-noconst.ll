...
define void @fusion(i8* noalias align 16 dereferenceable(65536) %alloc0, i8* noalias align 128 dereferenceable(65536) %alloc1) {
entry:
  ...
  %3 = bitcast i8* %2 to [128 x [128 x float]]*
  ...
  %19 = icmp ult i32 %linear_index_base, 16384
...
fusion.in_bounds-true:                            ; preds = %entry
  %20 = bitcast [128 x [128 x float]]* %1 to float*
  ...
  %38 = bitcast [128 x [128 x float]]* %3 to float*
