...
@rng_state = external dso_local unnamed_addr addrspace(1) global i128
@buffer_for_constant_3 = external local_unnamed_addr addrspace(1) constant [8 x i8], align 128
...
fusion_7.in_bounds-after:                         ; preds = %slice1-true, %slice0-after
  ret void
