...
define void @slice_5(i8* noalias align 16 dereferenceable(4096) %alloc0, i8* noalias align 128 dereferenceable(1024) %alloc4) {
entry:
  ...
  %8 = urem i32 %7, 32
  %9 = udiv i32 %linear_index_base, 32
  ...
  %14 = urem i32 %13, 32
  %15 = udiv i32 %linear_index2, 32
  %linear_index3 = add nuw nsw i32 %linear_index_base, 3
  %16 = udiv i32 %linear_index3, 1
  %17 = urem i32 %16, 32
  %18 = udiv i32 %linear_index3, 32
  %19 = icmp ult i32 %linear_index_base, 256
...
define void @slice_3(i8* noalias align 16 dereferenceable(4096) %alloc0, i8* noalias align 128 dereferenceable(1024) %alloc2) {
entry:
  %0 = getelementptr inbounds i8, i8* %alloc0, i64 0
  %1 = bitcast i8* %0 to [32 x [32 x float]]*
...
define void @slice_2(i8* noalias align 16 dereferenceable(4096) %alloc0, i8* noalias align 128 dereferenceable(1024) %alloc1) {
entry:
  %0 = getelementptr inbounds i8, i8* %alloc0, i64 0
  %1 = bitcast i8* %0 to [32 x [32 x float]]*
...
define void @slice_4(i8* noalias align 16 dereferenceable(4096) %alloc0, i8* noalias align 128 dereferenceable(1024) %alloc3) {
entry:
  %0 = getelementptr inbounds i8, i8* %alloc0, i64 0
  %1 = bitcast i8* %0 to [32 x [32 x float]]*
...
!3 = !{void (i8*, i8*)* @slice_3, !"reqntidx", i32 64}
