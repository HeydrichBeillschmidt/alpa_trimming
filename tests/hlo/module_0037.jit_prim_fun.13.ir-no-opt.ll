...
define void @broadcast_2(i8* noalias align 16 dereferenceable(4) %alloc0, i8* noalias align 128 dereferenceable(32768) %alloc1) {
entry:
  %0 = getelementptr inbounds i8, i8* %alloc0, i64 0
  %1 = bitcast i8* %0 to float*
  %2 = getelementptr inbounds i8, i8* %alloc1, i64 0
  %3 = bitcast i8* %2 to [256 x [32 x float]]*
  ...
  %19 = icmp ult i32 %linear_index_base, 8192
...
broadcast_2.in_bounds-true:                       ; preds = %entry
  ...
  %21 = bitcast [256 x [32 x float]]* %3 to float*
  ...
  %24 = bitcast [256 x [32 x float]]* %3 to float*
  ...
  %27 = bitcast [256 x [32 x float]]* %3 to float*
  ...
  %30 = bitcast [256 x [32 x float]]* %3 to float*
