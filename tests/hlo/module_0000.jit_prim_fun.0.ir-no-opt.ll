...
broadcast_2.in_bounds-true:                       ; preds = %entry
  ...
  %21 = bitcast [128 x [128 x float]]* %3 to float*
  ...
  %24 = bitcast [128 x [128 x float]]* %3 to float*
  ...
  %27 = bitcast [128 x [128 x float]]* %3 to float*
  ...
  %30 = bitcast [128 x [128 x float]]* %3 to float*
