...
define void @shift_right_logical_3(i8* noalias nocapture readonly align 16 dereferenceable(4) %alloc0, i8* noalias nocapture readonly align 16 dereferenceable(4) %alloc1, i8* noalias nocapture writeonly align 128 dereferenceable(4) %alloc2) local_unnamed_addr #0 {
entry:
  ...
  %5 = lshr i32 %3, %4
  %shft.chk = icmp ult i32 %4, 32
  %6 = select i1 %shft.chk, i32 %5, i32 0
  store i32 %6, i32 addrspace(1)* %0, align 128
  ret void
}
