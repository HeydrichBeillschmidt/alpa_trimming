...
entry:
  ...
  %11 = icmp ult i32 %linear_index_base, 144
...
broadcast_2.in_bounds-true:                       ; preds = %entry
  ...
  %13 = bitcast [144 x float]* %3 to float*
  ...
  %16 = bitcast [144 x float]* %3 to float*
  ...
  %19 = bitcast [144 x float]* %3 to float*
  ...
  %22 = bitcast [144 x float]* %3 to float*
