...
define void @fusion(i8* noalias nocapture readonly align 16 dereferenceable(4096) %alloc0, i8* noalias nocapture readonly align 16 dereferenceable(4) %alloc1, i8* noalias nocapture writeonly align 128 dereferenceable(4096) %alloc2) local_unnamed_addr #0 {
entry:
