...
define void @fusion(i8* noalias align 16 dereferenceable(4096) %alloc0, i8* noalias align 16 dereferenceable(4) %alloc1, i8* noalias align 128 dereferenceable(4096) %alloc2) {
entry:
  ...
  %5 = bitcast i8* %4 to [32 x [32 x float]]*
...
fusion.in_bounds-true:                            ; preds = %entry
  %22 = bitcast [32 x [32 x float]]* %1 to float*
  ...
  %44 = bitcast [32 x [32 x float]]* %5 to float*
