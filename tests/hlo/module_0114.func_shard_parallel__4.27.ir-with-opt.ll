...
@shared_cache = private unnamed_addr addrspace(3) global [1 x [1 x [32 x [33 x float]]]] undef
@shared_cache1 = private unnamed_addr addrspace(3) global [1 x [1 x [32 x [33 x i32]]]] undef
...
y_in_tile.loop_body.us:                           ; preds = %y_in_tile.loop_body.us.preheader, %y_in_tile.loop_body.us
