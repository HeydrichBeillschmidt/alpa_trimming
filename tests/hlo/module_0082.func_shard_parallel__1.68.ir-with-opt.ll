...
@buffer_for_constant_4 = local_unnamed_addr addrspace(1) constant [4 x i8] c"\01\00\00\00", align 128
...
scatter.10.in_bounds-after:                       ; preds = %entry, %scatter.in_bounds-true
  ret void
...
fusion_5.in_bounds-after:                         ; preds = %slice0-after, %slice1-true, %entry
  ret void
