...
define void @broadcast_2(i8* noalias align 16 dereferenceable(4) %alloc0, i8* noalias align 128 dereferenceable(65536) %alloc1) {
entry:
  %0 = getelementptr inbounds i8, i8* %alloc0, i64 0
  %1 = bitcast i8* %0 to float*
  %2 = getelementptr inbounds i8, i8* %alloc1, i64 0
  %3 = bitcast i8* %2 to [32 x [32 x [16 x float]]]*
  ...
  %23 = urem i32 %22, 16
  %24 = udiv i32 %linear_index3, 16
  %25 = urem i32 %24, 32
  %26 = udiv i32 %linear_index3, 512
...
broadcast_2.in_bounds-true:                       ; preds = %entry
  ...
  %29 = bitcast [32 x [32 x [16 x float]]]* %3 to float*
  ...
  %32 = bitcast [32 x [32 x [16 x float]]]* %3 to float*
  ...
  %35 = bitcast [32 x [32 x [16 x float]]]* %3 to float*
  ...
  %38 = bitcast [32 x [32 x [16 x float]]]* %3 to float*
